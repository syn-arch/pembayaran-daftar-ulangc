					...
					<div class="col-md-8 offset-md-2">
						<form method="POST">
							<div class="form-group">
								...
								<input type="text" id="id_kelas" name="id_kelas" class="form-control id_kelas <?php if(form_error('id_kelas')) echo 'is-invalid'?>" placeholder="ID Kelas" value="<?php echo $kelas['id_kelas'] ?>">
