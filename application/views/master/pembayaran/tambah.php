					...
					<div class="col-md-8 offset-md-2">
						<form method="POST">
							...
							<div class="form-group">
								...
								<input type="text" id="nominal" name="nominal" class="form-control nominal <?php if(form_error('nominal')) echo 'is-invalid'?>" placeholder="Nominal" value="<?php echo set_value('nominal') ?>">
